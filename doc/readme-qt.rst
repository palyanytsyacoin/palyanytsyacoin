PalyanytsyaCoin-qt: Qt4 GUI for PalyanytsyaCoin
===============================
...
Alternatively, install Qt Creator and open the `PalyanytsyaCoin-qt.pro` file.

An executable named `PalyanytsyaCoin-qt` will be built.
...
A warning for people using the *static binary* version of PalyanytsyaCoin on a Linux/UNIX-ish system (tl;dr: **Berkely DB databases are not forward compatible**).

The static binary version of PalyanytsyaCoin is linked against libdb5.3.
...
installed causes PalyanytsyaCoin-qt to crash intermittently.  The issue has been reported as `launchpad bug 857790`_, but
isn't yet fixed.
