...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("PLCS");
    case mBTC: return QString("mPLCS");
    case uBTC: return QString::fromUtf8("μPLCS");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("PalyanytsyaCoins"));
    case mBTC: return QString(QObject::tr("Milli-PalyanytsyaCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-PalyanytsyaCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
